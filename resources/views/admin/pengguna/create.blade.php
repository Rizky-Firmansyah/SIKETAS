...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            <a href="/data-user" class="btn btn-primary btn-sm mb-2">
        ...
        <div class="container">
            <div class="row">
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <form action="/data-user/createData" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" placeholder="Isi Email Pengguna" name="email">
                            </div>
                            <div class="mb-3">
