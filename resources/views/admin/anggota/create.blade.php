...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            <a href="/data-anggota" class="btn btn-primary btn-sm mb-2">
        ...
        <div class="container">
            <div class="row">
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <form action="/data-anggota/createData" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Nama Petani</label>
                                <input type="text" class="form-control" placeholder="Isi Nama Petani" name="nama_petani">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Isi No Handphone" name="no_hp">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Umur</label>
                                <input type="text" class="form-control" placeholder="Isi Umur" name="umur">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Luas Lahan</label>
                                <input type="text" class="form-control" placeholder="Isi Luas Lahan" name="luas_lahan">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">No Sertifikat</label>
                                <input type="text" class="form-control" placeholder="Isi Nomor Sertifikat"
                                    name="no_sertifikat">
                            </div>
