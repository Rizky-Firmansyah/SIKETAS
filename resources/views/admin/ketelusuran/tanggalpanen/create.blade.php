...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-light">Form Tambah Tanggal Panen</h1>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <form action="/tanggal-panen/createData" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" placeholder="Isi Lat" name="tanggal">
                            </div>
