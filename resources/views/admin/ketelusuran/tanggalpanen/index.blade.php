    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between text-light">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="teks-manajemen h3 mb-0" style="color: black">Data Panen</h1>
            </div>
            <a href="/tanggal-panen/create" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($tanggal as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/data-petani/{{ $item->id_tanggal_panen }}"
