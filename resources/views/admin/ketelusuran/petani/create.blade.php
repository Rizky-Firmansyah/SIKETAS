        ...
        <div class="container">
            <div class="row">
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <form action="/data-petani/createData" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="tgl_panen2">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="Masukkan Jumlah Janjang Panen 2" name="janjang_panen2">
                                    </div>
                                </div>
                            </div>
                            {{-- Panen 3 --}}
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="tgl_panen3">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="Masukkan Jumlah Janjang Panen 3" name="janjang_panen3">
                                    </div>
                                </div>
                            </div>
